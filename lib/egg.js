...
class EggApplication extends EggCore {
  ...
  constructor(options = {}) {
    ...
    // 基于egg-logger的EggContextLogger
    this.ContextLogger = ContextLogger;
    // 基于context_httpclient.js
     ...
     * @since 1.0.0
     */
    // 基于Messenger/index.js ,创建本地或多进程通信器
    ...
    this.messenger.once('egg-ready', () => {
      // 当收到通信消息后，触发生命周期之serverDidReady
